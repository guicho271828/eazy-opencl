...
(cl:defun lispify-wo-prefix (name cl:&optional flag)
  (cl:assert (cl:zerop (cl:search "CL_" name)))
  (lispify (cl:subseq name 3) flag))
...
(cl:export
 (cl:list
  ...
  (lispify "CL_CHAR_BIT" :constant)
  (lispify "CL_SCHAR_MAX" :constant)
  (lispify "CL_SCHAR_MIN" :constant)
  (lispify "CL_CHAR_MAX" :constant)
  (lispify "CL_CHAR_MIN" :constant)
  (lispify "CL_UCHAR_MAX" :constant)
  (lispify "CL_SHRT_MAX" :constant)
  (lispify "CL_SHRT_MIN" :constant)
  (lispify "CL_USHRT_MAX" :constant)
  (lispify "CL_INT_MAX" :constant)
  (lispify "CL_INT_MIN" :constant)
  (lispify "CL_UINT_MAX" :constant)
  (lispify "CL_LONG_MAX" :constant)
  (lispify "CL_LONG_MIN" :constant)
  (lispify "CL_ULONG_MAX" :constant)
  (lispify "CL_FLT_DIG" :constant)
  (lispify "CL_FLT_MANT_DIG" :constant)
  (lispify "CL_FLT_MAX_10_EXP" :constant)
  (lispify "CL_FLT_MAX_EXP" :constant)
  (lispify "CL_FLT_MIN_10_EXP" :constant)
  (lispify "CL_FLT_MIN_EXP" :constant)
  (lispify "CL_FLT_RADIX" :constant)
  (lispify "CL_FLT_MAX" :constant)
  (lispify "CL_FLT_MIN" :constant)
  (lispify "CL_FLT_EPSILON" :constant)
  (lispify "CL_DBL_DIG" :constant)
  (lispify "CL_DBL_MANT_DIG" :constant)
  (lispify "CL_DBL_MAX_10_EXP" :constant)
  (lispify "CL_DBL_MAX_EXP" :constant)
  (lispify "CL_DBL_MIN_10_EXP" :constant)
  (lispify "CL_DBL_MIN_EXP" :constant)
  (lispify "CL_DBL_RADIX" :constant)
  (lispify "CL_DBL_MAX" :constant)
  (lispify "CL_DBL_MIN" :constant)
  (lispify "CL_DBL_EPSILON" :constant)
  (lispify "CL_NAN" :constant)
  (lispify "CL_HUGE_VALF" :constant)
  (lispify "CL_HUGE_VAL" :constant)
  (lispify "CL_MAXFLOAT" :constant)
  (lispify "CL_INFINITY" :constant)))
